...
This goal matches the Release 1 goal in \`RPM.md\`.  
\---
...
|----------------|-------------------------|--------|  
| Hemish Ahuja   | 15 h                     | Implement login and protect pages (springboot security), buy and sell features (including auto field population),  portfolio value updation, API integration infrastructure |  
...
| Mark Feng      | 12 h                     | System Design, Diagram, Trello, user stories, Login |  
| Total      |  55h                | sufficient for 4 stories
...
- [ ] Update \`README.md\` with “How to run Spring Boot” (already in repo)   
...
\- We will keep all remote branches until Sprint 1 marking is finished (per handout). 
...
\- If buy/history is not finished in Sprint 1, we will add the unfinished items to SR1.md and move them to Sprint 2 (per handout). 
